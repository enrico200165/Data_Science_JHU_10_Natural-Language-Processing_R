...
As a consequence of the fact that a blog, news item and tweets are all stored
within a single line we notice some unsuale maximus for line lengths.
Also, the originary files contained unsual characters not compatible 
with the NLP tool and caused it to truncate some readings, a clean-up
was necessary to remove such characters.
