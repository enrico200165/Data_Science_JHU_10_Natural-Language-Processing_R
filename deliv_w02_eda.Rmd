...
Now using Quanteda we calculate that __coverage of `r paste0(to_cover*100,"%")` of tokens is provided by `r paste0(round(types_coverage_data$pct_to_cover*100,2),"%")` of the types__, let's also visualize the cumulative frequencies looking at the
